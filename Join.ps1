...
New-Item -ItemType file C:\k\logs\kubeleterr.log
New-Item -ItemType file C:\k\logs\kubeletstdout.log
New-Item -ItemType file C:\k\logs\kubeproxyerr.log
New-Item -ItemType file C:\k\logs\kubeproxystdout.log
New-Item -ItemType file C:\k\logs\flannelderr.log
New-Item -ItemType file C:\k\logs\flanneldstdout.log
.\nssm.exe set kubelet AppStderr C:\k\logs\kubeleterr.log
.\nssm.exe set kubelet AppStdout C:\k\logs\kubeletstdout.log
.\nssm.exe set kube-proxy AppStderr C:\k\logs\kubeproxyerr.log
.\nssm.exe set kube-proxy AppStdout C:\k\logs\kubeproxystdout.log
.\nssm.exe set flanneld2 AppStderr C:\k\logs\flannelderr.log
.\nssm.exe set flanneld2 AppStdout C:\k\logs\flanneldstdout.log
